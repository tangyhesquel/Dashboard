// ================================================================================
// Create by  : Richard Zhao
// Create date: 2011-09-27
// Description: SQL helper class allow execute sql command by ADO.NET.
// --------------------------------------------------------------------------------
...
namespace DashBoardWebService
{
    ...
    public sealed class SqlHelper
    {
        ...
        private static readonly string connectionString = ConfigurationManager.ConnectionStrings["DASHBOARDConnection"].ConnectionString;
        private static readonly int timeout = 100; //int.Parse(ConfigurationManager.AppSettings["dbTimeOut"], CultureInfo.InvariantCulture);
        ...
        public static void ExecuteNonQuery(string commandType, string commandText)
        {
            //pass through the call providing null for the set of SqlParameters
            if (commandType == "TEXT")
                ExecuteNonQuery(connectionString, CommandType.Text, commandText);
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetStoreProcedureParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetStoreProcedureParameterSet(connection.ConnectionString, spName);
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetStoreProcedureParameterSet(transaction.Connection.ConnectionString, spName);
        ...
        {
            return ExecuteDataSetWithRet(ref returnValue, connectionString, CommandType.StoredProcedure, spName, parameterValues);
        }
        /// <summary>
        /// Execute a SqlCommand (that returns a resultset) against the database specified in the connection string 
        /// using the provided parameters.
        ...
        /// <returns>an object containing the value in the 1x1 resultset generated by the command</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope")]
        public static DataSet ExecuteDataSetWithRet(ref int returnValue, string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                cn.Open();
        ...
        /// <param name="parameterValues">an array of SqlParamters used to execute the command</param>
        /// <returns>a SqlDataReader containing the resultset generated by the command</returns>
        public static SqlDataReader ExecuteReader(CommandType commandType, string commandText, SqlParameter[] parameterValues)
        {
        ...
        public static DataSet ExecuteSqlReader(string Sql, String TableName)
        {

            SqlConnection conn = new SqlConnection();
            conn.ConnectionString = ConfigurationManager.ConnectionStrings["PcsConnection"].ConnectionString;
        ...
        public static DataSet ExecuteSqlReader(DataSet ds, string Sql, String TableName)
        {
            SqlConnection conn = new SqlConnection();
            conn.ConnectionString = ConfigurationManager.ConnectionStrings["PcsConnection"].ConnectionString;
            SqlCommand command = new SqlCommand(Sql, conn);
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        /// <returns>an array of SqlParameters</returns>
        public static SqlParameter[] GetStoreProcedureParameterSet(string connectionString, string spName, bool includeReturnValueParameter)
        {
